...
class TemplateController extends Controller
{
    ...
    {
        $categories = Category::orderByRaw("FIELD(id, 'website', 'marketing', 'social', 'custom') ASC")->get();

        $templates = Template::with('category')->orderByRaw("FIELD(category_id, 'website', 'marketing', 'social', 'custom') ASC")->paginate(500);
