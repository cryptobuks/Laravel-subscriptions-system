@if(isset($view))
    ...
    @if(in_array($view, ['subheadline', 'about-us', 'call-to-action', 'headline', 'mission-statement', 'newsletter', 'press-release', 'value-proposition', 'vision-statement', 'video-script', 'social-post', 'social-post-caption']))
        <div class="form-group">
